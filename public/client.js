  ...
  function (gltf) {
    ...
    object.traverse((child)=>{
      if(child.material){
        ...
        // else if(i==13){
        //   // child.material.name = "mur"
        //   boxMaterial = child.material
        // }else if(i==41){
        //   parterMaterial = child.material
        // }else if(i==109){
        //   arterMaterial = child.material
        // }
      }
...
imgoeil.addEventListener('touchstart', ()=>{
  console.log("touche")
